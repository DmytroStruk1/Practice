...
- зафіксовані додаткові події, які не були такими популярними:  
  ...
  + у 2005 році в Українського домі, галерея "Триптих" провела найбільшу виставка Марчук, яка зайняла 4 поверехи. А також Дмитро Гордон провів [інтерв'ю з генієм](https://www.youtube.com/watch?v=Bm8SwmnDyDs)  ;
